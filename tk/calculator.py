...
class Calculator():
    def __init__(self):
        ...
        button_add = Button(root, text="+", padx=39, pady=20, command=self.add_numbers)
        button_subtract = Button(root, text="-", padx=40, pady=20, command=self.subtract_numbers)
        button_multiply = Button(root, text="*", padx=40, pady=20, command=self.multiply_numbers)
        button_divide = Button(root, text="/", padx=41, pady=20, command=self.divide_numbers)
        button_equal = Button(root, text="=", padx=87, pady=20, command=self.equals)
        button_clear = Button(root, text="Clear", padx=77, pady=20, command=self.button_clear_input)
